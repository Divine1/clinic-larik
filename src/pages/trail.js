...
class TrialPage extends Component{
    ...
    componentDidMount() {
        scrollToComponent(this.Red, { offset: 0, align: 'middle', duration: 500, ease:'linear'});
    }
    //top,bottom,middle
    render(){
        return(
            <div className='maintrail'>
                <div className='button_group'>
                    ...
                    <button onClick={() => scrollToComponent(this.Indigo, { offset: 0, align: 'middle', duration: 500, ease:'inExpo'})}>Go To Indigo</button>
